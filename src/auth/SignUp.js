  ...
  return (
    <div className="max-w-sm mx-auto mt-24">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <button 
          className="w-full bg-green-600 text-white py-2 rounded disabled:opacity-50 flex justify-center items-center"
          disabled={isLoading || !f.username || !f.email || !f.password}
        >
          {isLoading ? (
            <>
